...
@interface LFNavTabBarController ()<UIScrollViewDelegate,LFNavTabBarDelegate> {
    NSInteger _currentIndex;
    NSMutableArray *_titles;
    LFNavTabBar *_navTabBar;
    UIScrollView *_mainView;
}

@end

@implementation LFNavTabBarController
...
- (void)viewInit
{
    ...
    _navTabBar = [[LFNavTabBar alloc] initWithFrame:CGRectMake(DOT_COORDINATE, DOT_COORDINATE, SCREEN_WIDTH, NAV_TAB_BAR_HEIGHT) showArrowButton:_showArrowButton];
    _navTabBar.delegate = self;
    _navTabBar.backgroundColor = _navTabBarColor;
    _navTabBar.lineClolr = _navTabBarLineColor;
